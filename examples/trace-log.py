...
# a data.message object or None if the line does not represent a message
...
def log_to_csv(logfile, parser, outpath):
    ...
    for raw, parsed in unp:
        ...
        for msg in parsed['can0']:
            ...
            writers[msg].writerow(chain([raw.time], parsed['can0'][msg].values()))
